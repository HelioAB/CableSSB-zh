function arrow_handle = plot(obj,options)
    ...
    arrow_handle = Load.getArrow(apply_ijpoint,[delta_X_i,delta_X_j],[delta_Y_i,delta_Y_j],[delta_Z_i,delta_Z_j],options.Color,options.Figure,options.Axis);

    start_X_i = [apply_ipoint.X]-delta_X_i;
    start_X_j = [apply_jpoint.X]-delta_X_j;
    start_Y_i = [apply_ipoint.Y]-delta_Y_i;
    start_Y_j = [apply_jpoint.Y]-delta_Y_j;
    start_Z_i = [apply_ipoint.Z]-delta_Z_i;
    start_Z_j = [apply_jpoint.Z]-delta_Z_j;
