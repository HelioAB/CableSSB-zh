function data = getInternalForceFromAnsys(obj,num_MonitoredElems_Link,num_MonitoredElems_Beam)
    arguments
        obj
    ...
    Fyi_beam = data_beam(:,6)';
    Fyj_beam = data_beam(:,7)';
    Fzi_beam = data_beam(:,8)';
    Fzj_beam = data_beam(:,9)';
    Mxi_beam = data_beam(:,10)';
    Mxj_beam = data_beam(:,11)';
    Myi_beam = data_beam(:,12)';
    Myj_beam = data_beam(:,13)';
    ...
    data.Fyi_beam = Fyi_beam;
    data.Fyj_beam = Fyj_beam;
    data.Fzi_beam = Fzi_beam;
    data.Fzj_beam = Fzj_beam;
    data.Mxi_beam = Mxi_beam;
    data.Mxj_beam = Mxj_beam;
...
function output_str = getInternalForceStr(obj,OutputMethod,num_MonitoredElems_Link,num_MonitoredElems_Beam)
    ...
    if ~isempty(num_MonitoredElems_Beam)
        str_beams_define = ['! 定义变量（beam单元）',newline,...
                            ...
                            '*dim,Fyi_beam,array,count_elements_beam',newline,...
                            '*dim,Fyj_beam,array,count_elements_beam',newline,...
                            '*dim,Fzi_beam,array,count_elements_beam',newline,...
                            '*dim,Fzj_beam,array,count_elements_beam',newline,...
                            '*dim,Mxi_beam,array,count_elements_beam',newline,...
                            '*dim,Mxj_beam,array,count_elements_beam',newline,...
        ...
        str_beams_get = ['! 提取内力（beam单元）',newline,...
                         ...
                         '    *get,Fyi_beam(i),Elem,num_elements_beam(i),Smisc,6',newline,...
                         '    *get,Fyj_beam(i),Elem,num_elements_beam(i),Smisc,19',newline,...
                         '    *get,Fzi_beam(i),Elem,num_elements_beam(i),Smisc,5',newline,...
                         '    *get,Fzj_beam(i),Elem,num_elements_beam(i),Smisc,18',newline,...
                         '    *get,Mxi_beam(i),Elem,num_elements_beam(i),Smisc,4',newline,...
                         '    *get,Mxj_beam(i),Elem,num_elements_beam(i),Smisc,17',newline,...
        ...
        str_beams_out = ['! 导出数据（beam单元）',newline,...
                         ...
                         '*vwrite,num_elements_beam(1),num_INode_beam(1),num_JNode_beam(1),Fxi_beam(1),Fxj_beam(1),Fyi_beam(1),Fyj_beam(1),Fzi_beam(1),Fzj_beam(1),Mxi_beam(1),Mxj_beam(1),Myi_beam(1),Myj_beam(1),Mzi_beam(1),Mzj_beam(1)',newline,...
                         '(15E20.8)',newline,...
                         '*cfclos',newline];
    else
        str_beams_define = [];
