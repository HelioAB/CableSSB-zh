function coo_sym = csr2coo(obj,csr_row_pointers,csr_col_indices,csr_values)
    ...
    % 转换成对称阵
    diag_matrix = diag(coo_matrix);
    [m,n] = size(coo_matrix);
    coo_sym = coo_matrix + coo_matrix' - spdiags(diag_matrix, 0, m, n);
end