function obj = HybridBirgde_NonHanger()
    ...
    P_z = obj.getGirderWeight/(count_hanger+obj.getLineCountOfClass('StayedCable'));
    ...
    folder = ['C:\Users\Huawei\Desktop\Matlab OOP\Susp\Susp V.4\Chapter02\Result\NonHanger'];
    obj.OutputMethod.WorkPath = folder;
    obj.OutputMethod.JobName = 'NonHanger';
